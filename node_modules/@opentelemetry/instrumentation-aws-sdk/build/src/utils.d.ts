...
export declare const normalizeV2Request: (awsV2Request: Request<any, any>) => NormalizedRequest;
...
export declare const bindPromise: (target: Promise<any>, contextForCallbacks: Context, rebindCount?: number) => Promise<any>;
