...
router.post('/', function(req, res, next) {
    if (req.body.__action == 'test_once') {
        ...
        const group_work = res.locals.assessment ? res.locals.assessment.group_work : false;
        question.startTestQuestion(count, showDetails, res.locals.question, group_work, res.locals.course_instance, res.locals.course, res.locals.authn_user.user_id, (err, job_sequence_id) => {
